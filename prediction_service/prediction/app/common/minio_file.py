...
from config.global_variables import (
    ...
    MINIO_URL,
    MINIO_BUCKET,
    MINIO_UNPROCESS_FOLDER_NAME,
    MINIO_PROCESSED_FOLDER_NAME
)
...
def minio_copy_obj(name_obj):
    try:
        print('************ it is copying ************')

        response = client.copy_object(
            MINIO_BUCKET,
            name_obj.replace(MINIO_UNPROCESS_FOLDER_NAME,
                             MINIO_PROCESSED_FOLDER_NAME),
            CopySource(MINIO_BUCKET, name_obj),)
...
def minio_remove_obj(name_obj):
    try:
        print('************ it is remving the object ******', name_obj)

        client.remove_object(
            MINIO_BUCKET, name_obj,
        )
